...
let checked = 0;
for (const file of readdirSync(new URL('..', import.meta.url)).filter(name => name.endsWith('.js'))) {
  ...
  Object.assign(params, { at: '(at 0 0)', r: 0, rot: 0, ref: 'QA1', ref_hide: '', from: net, to: net, P1: net, P2: net, P3: net, P4: net, local_net: () => net, eaxy: (x, y) => `${x} ${y}` });
